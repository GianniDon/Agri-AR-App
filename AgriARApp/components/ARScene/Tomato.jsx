...
const API_KEY = 'sk-ItsJ67d05e1252f1e9092'; // Note: This should be a complete Perenual API key
const query = "tomato";

const modelAsset = Asset.fromModule(require('../../assets/models/source/tomato-plant.obj'));
const textureAssets = {
  leaves: Asset.fromModule(require('../../assets/models/textures/tomato_texture/tomato_albedo2_NRM.jpeg')),
  fruit: Asset.fromModule(require('../../assets/models/textures/tomato_texture/tomato_albedo2.png')),
  mask: Asset.fromModule(require('../../assets/models/textures/tomato_texture/mask-SF.png')),
  disp: Asset.fromModule(require('../../assets/models/textures/tomato_texture/tomato_crazy1_DISP.png')),
  occ: Asset.fromModule(require('../../assets/models/textures/tomato_texture/tomato_crazy1_OCC.png')),
  spec: Asset.fromModule(require('../../assets/models/textures/tomato_texture/tomato_crazy1_SPEC.png')),
};

const SCREEN_HEIGHT = Dimensions.get('window').height;

const TomatoScene = ({ showAR, onStopAR, navigation }) => {
  // States
  ...
  const onContextCreate = async (gl) => {
    try {
      ...
      const textureFruit = new TextureLoader().load(fruitTextureUri);
      textureFruit.encoding = sRGBEncoding;
      ...
      const materialFruit = new MeshStandardMaterial({
        map: textureFruit
      });
